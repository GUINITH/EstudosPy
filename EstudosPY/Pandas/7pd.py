...
- Dacdos incorretos podem ser:
    * Célula vazias
    * Dados em formato errado
    * Dados errados
    * Duplicatas
Neste tutorial você aprenderá como lidar com todos eles
'''
...
# O conjunto de dados contém formato incorreto ('Data' na linha 26).
# O conjunto de dados contém dados erados ('Duração' na linha 7)
