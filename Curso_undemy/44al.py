...
format_cpf = cpf_usuario[:9]

# Calculando o primeiro dígito
soma = 0 
contagem = 10 
for digito  in format_cpf:
...
"""
# calculo do segundo número 

soma = 0 
contagem =11 
for digito2 in format_cpf:
    digito2 += str(primeiro_digito)
    soma += int(digito2) * contagem  
    contagem -= 1
